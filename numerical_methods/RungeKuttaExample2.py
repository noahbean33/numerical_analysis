"""Runge-Kutta 4th order method - Example 2: Heavily damped pendulum."""
import numpy as np
...
def runge_kutta_method(x: float = 0, v: float = 1, g: float = 9.8, l: float = 1, 
                        dt: float = 0.1, b: float = 2) -> None:
    """Solve heavily damped pendulum using Runge-Kutta 4th order method.
    ...
    Args:
        ...
        l: Pendulum length
        dt: Time step
        b: Damping coefficient (higher than Example1)
    """
    x_values = []
    t_values = []
    t = 0.0
